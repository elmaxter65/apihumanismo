...
class TemplatesInitController extends Controller
{
    public function index()
    {
        $pageConfigs = ['pageHeader' => false,];
        return view('templates-init.index', compact('pageConfigs'));
    }

    public function getJson()
    {
        $templates = Template::where( 'init', 1 )->get();
    ...
    {
        $pageConfigs = ['pageHeader' => false,];
        return view('templates-init.create', compact('pageConfigs'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('templates-init.edit', compact( 'template', 'pageConfigs'));
    }
    ...
    public function store(TemplateRequest $request)
    {
        ...
        try {
            ...
            DB::commit();
            return redirect()->route('templates-init.index')->with('message', 'Item store successfully');
        } catch (\Exception $e) {
            //dd($e);
            DB::rollBack();
