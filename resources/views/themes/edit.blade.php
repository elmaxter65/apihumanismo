...
@section('title', __('locale.edit-theme'))
                                                            ...
                                                            <div class="col-md-6 d-flex justify-content-end">
                                                                ...
                                                                <div class="form-check form-check-primary form-switch">
                                                                    <input
                                                                        ...
                                                                        id="visibility"
                                                                        name="visibility" @if ( $theme->visibility == 1 ) {{'checked'}} @endif />
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="mb-1 ps-md-0 pe-md-0">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12 col-md-12 pe-md-0">
                                            <div class="mb-1 ps-md-2 pe-md-50">
                                                <input type="hidden" id="start_position_flat" name="start_position_flat" value="@if($theme->start_position != 0) {{'true'}}@else{{'false'}}@endif">
                                                <select
                                                    class="form-select py-1 @if ($errors->has('start_position')) {{ 'invalid' }} @endif"
                                                    id="start_position"
                                                    name="start_position">
                                                    <option value="1" @if ( $theme->start_position == 1) {{ 'selected' }} @endif>1</option>
                                                    <option value="2" @if ( $theme->start_position == 2) {{ 'selected' }} @endif>2</option>
                                                    <option value="3" @if ( $theme->start_position == 3) {{ 'selected' }} @endif>3</option>
                                                    <option value="4" @if ( $theme->start_position == 4) {{ 'selected' }} @endif>4</option>
                                                    <option value="5" @if ( $theme->start_position == 5) {{ 'selected' }} @endif>5</option>
                                                    <option value="6" @if ( $theme->start_position == 6) {{ 'selected' }} @endif>6</option>
                                                    <option value="7" @if ( $theme->start_position == 7) {{ 'selected' }} @endif>7</option>
                                                    <option value="8" @if ( $theme->start_position == 8) {{ 'selected' }} @endif>8</option>
                                                    <option value="9" @if ( $theme->start_position == 9) {{ 'selected' }} @endif>9</option>
                                                </select>
