...
@section('vendor-style')
    ...
    <link
        ...
        rel="stylesheet">
    <link rel="stylesheet" href="{{ asset('vendors/trumbowyg/ui/trumbowyg.css') }}">
    <link rel="stylesheet" href="{{ asset('vendors/trumbowyg/plugins/table/ui/trumbowyg.table.css') }}">
@endsection
@section('page-style')
...
@section('title', __('locale.create-content-template'))

@section('content')
    <section>
        <div class="row">
            <form method="POST" action="{{ route('templates.store') }}" enctype="multipart/form-data" id="form">
                <input
                    type="hidden"
                    id="urlGetSections"
                    name="urlGetSections"
...
@section('vendor-script')
    ...
    <script src="{{ asset('vendors/trumbowyg/trumbowyg.js') }}"></script>
    <script src="{{ asset('vendors/trumbowyg/plugins/base64/trumbowyg.base64.js') }}"></script>
    <script src="{{ asset('vendors/trumbowyg/plugins/colors/trumbowyg.colors.js') }}"></script>
    <script src="{{ asset('vendors/trumbowyg/plugins/fontfamily/trumbowyg.fontfamily.js') }}"></script>
    <script src="{{ asset('vendors/trumbowyg/plugins/fontsize/trumbowyg.fontsize.js') }}"></script>
    <script src="{{ asset('vendors/trumbowyg/plugins/history/trumbowyg.history.js') }}"></script>
    <script src="{{ asset('vendors/trumbowyg/plugins/indent/trumbowyg.indent.js') }}"></script>
    <script src="{{ asset('vendors/trumbowyg/plugins/insertaudio/trumbowyg.insertaudio.js') }}"></script>
    <script src="{{ asset('vendors/trumbowyg/plugins/lineheight/trumbowyg.lineheight.js') }}"></script>
    <script src="{{ asset('vendors/trumbowyg/plugins/pasteembed/trumbowyg.pasteembed.js') }}"></script>
    <script src="{{ asset('vendors/trumbowyg/plugins/pasteimage/trumbowyg.pasteimage.js') }}"></script>
    <script src="{{ asset('vendors/trumbowyg/plugins/preformatted/trumbowyg.preformatted.js') }}"></script>
    <script src="{{ asset('vendors/trumbowyg/plugins/table/trumbowyg.table.js') }}"></script>
    <script src="{{ asset('vendors/trumbowyg/plugins/noembed/trumbowyg.noembed.js') }}"></script>
    <script src="{{ asset('vendors/trumbowyg/plugins/pasteembed/trumbowyg.pasteembed.js') }}"></script>
@endsection
@section('page-script')
    <!-- Page js files -->
