...
@section('title', __('locale.content-template'))
...
@section('content')
    ...
    <div class="card">
        <div class="d-flex justify-content-between align-items-center header-actions mx-2 row px-xxl-75 dataTables-Header">
            ...
            <div class="col-sm-12 col-md-6">
                <h3 class="link-dark">{{ __('locale.content-template') }}</h3>
            </div>
        ...
        <input type="hidden" name="getJson" id="getJson" value="{{ route('templates.get-json') }}" />
        <input type="hidden" name="urlBase" id="urlBase" value="{{ route('templates.index') }}">
            ...
            <table class="user-list-table table">
                <thead class="table-light">
                    <tr>
                        ...
                        <th class="col-6">
                            <div class="ps-md-4">{{ __('locale.indexed') }}</div>
                        </th>
                        <th></th>
                    </tr>
                </thead>
    ...
    <form method="POST" action="" class="d-flex" id="form-delete">
        @csrf
        @method( 'DELETE' )
        <input type="hidden" name="urlDelete" id="urlDelete" value="{{ route('templates.destroy', [-1]) }}">
    </form>
    <!-- Vertical modal end-->
@endsection
