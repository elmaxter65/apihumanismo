@if ($configData['mainLayoutType'] === 'horizontal' && isset($configData['mainLayoutType']))
    <nav class="header-navbar navbar-expand-lg navbar navbar-fixed align-items-center d-xl-none navbar-shadow navbar-brand-center {{ $configData['navbarColor'] }}"
    ...
    @else
        <nav
            class="header-navbar navbar navbar-expand-lg align-items-center d-xl-none {{ $configData['navbarClass'] }} navbar-light navbar-shadow {{ $configData['navbarColor'] }} {{ $configData['layoutWidth'] === 'boxed' && $configData['verticalMenuNavbarType'] === 'navbar-floating'? 'container-xxl': '' }}">
@endif
<div class="navbar-container d-xl-none content">
    <div class="bookmark-wrapper d-xl-none align-items-center">
