...
@section('title', __('locale.create-tag'))

@section('content')
    <section>
        <div class="row">
            <form method="POST" action="{{ route('tags.store') }}" enctype="multipart/form-data" id="form">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 d-flex justify-content-end px-0">
                                            ...
                                            <button type="submit" class="btn btn-primary ms-75 round py-1"
                                                style="color: #282828!important;">{{ __('locale.create') }}</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
