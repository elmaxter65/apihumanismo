...
@section('title', __('locale.edit-tag'))

@section('content')
    <section>
        <div class="row">
            <form method="POST" action="{{ route('tags.update', [$tag->id]) }}" enctype="multipart/form-data" id="form">
                <input type="hidden" name="urlGetSlug" id="urlGetSlug" value="{{ route('tags.get-slug') }}">
                @csrf
                @method( 'PUT' )
                                        ...
                                        <div class="col-sm-12 col-md-12 pe-md-0">
                                            <div class="mb-1 ps-md-2 pe-md-50">
                                                ...
                                                <input type="text" id="name"
                                                    ...
                                                    name="name" value="{{ $tag->taglanguage[0]->name }}"
