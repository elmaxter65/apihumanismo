...
<div class="auth-wrapper auth-cover">
  <div class="auth-inner row m-0">
    ...
    <!--a class="brand-logo" href="#">
      ...
      <h2 class="brand-text text-primary ms-1">Nebolus</h2>
    </a-->
    <!-- /Brand logo-->

    <!-- Left Text-->
    <div class="d-none d-lg-flex col-lg-8 align-items-center p-5" style="background-color: #282828!important;">
      <div class="w-100 d-lg-flex align-items-center justify-content-center px-5 bg-dark">
        @if($configData['theme'] === 'dark')
          <img class="img-fluid width-400" src="{{asset('images/logo/logo-alt-2.svg')}}" alt="Login V2" />
          @else
          <img class="img-fluid width-400" src="{{asset('images/logo/logo-alt-2.svg')}}" alt="Login V2" />
          @endif
      </div>
    ...
    <div class="d-flex col-lg-4 align-items-center auth-bg px-2 p-lg-5">
      <div class="col-12 col-sm-8 col-md-6 col-lg-12 px-xl-2 mx-auto">
        <h2 class="card-title fw-bold mb-1">{{__('locale.welcome-nebolus')}}</h2>
        ...
        <form class="auth-login-form mt-2" action="login" method="POST">
          ...
          <button type="submit" class="btn btn-primary w-100" tabindex="4">Acceder</button>
        </br></br>
